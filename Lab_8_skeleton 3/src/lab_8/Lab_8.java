...
public class Lab_8 {
    ...
    private void runAnalysis(){
       ...
       // helper.userWithMostLikes();
        ...
        helper.fiveMostInactiveUserPost();
        helper.fiveMostInactiveUserComment();
        helper.inactiveUsersOnPostsLikeandComments();
        helper.proactiveUsersOnPostsLikeandComments();
