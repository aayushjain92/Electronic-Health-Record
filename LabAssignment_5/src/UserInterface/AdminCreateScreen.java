...
public boolean validation()
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
       ...
       if(radioCustomer.isSelected()){
            ...
            validation(CustUsername,Custpassword);
         ...
         validation(Suppusername,Supppassword);
        ...
        private void validation(String username, String pass){
        ...
        if(m.matches()== false){
            JOptionPane.showMessageDialog(null,"Username should be a vaild gmail address");
            return;
        }
